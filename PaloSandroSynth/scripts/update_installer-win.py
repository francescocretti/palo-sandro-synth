...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PaloSandroSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=PaloSandroSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PaloSandroSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PaloSandroSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PaloSandroSynth Demo installer\n"
     else:
       line="SetupWindowTitle=PaloSandroSynth installer\n"
