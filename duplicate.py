...
def main():
  ...
  for dir in dirwalk(outputpath, inputprojectname, outputprojectname, "FrancescoCretti", manufacturer, oldroot, newroot):
    pass

  #replace project name in root
  for dir in dirwalk(scriptpath, inputprojectname, outputprojectname, "FrancescoCretti", manufacturer, oldroot, newroot):
    pass

  #replace project name in github
  for dir in dirwalk(scriptpath + "/.github/workflows", inputprojectname, outputprojectname, "FrancescoCretti", manufacturer, oldroot, newroot):
    pass

  #replace project name in vscode
  for dir in dirwalk(scriptpath + "/.vscode", inputprojectname, outputprojectname, "FrancescoCretti", manufacturer, oldroot, newroot):
    pass
